...
const areas = [
  ...
  { city: "Henderson", state: "NV", zones: 5 },
  { city: "Reno", state: "NV", zones: 4 },
  { city: "Denver Metro", state: "CO", zones: 12 },
  { city: "Colorado Springs", state: "CO", zones: 7 },
  { city: "Boulder", state: "CO", zones: 4 },
  { city: "Fort Collins", state: "CO", zones: 4 },
  { city: "Salt Lake City", state: "UT", zones: 10 },
  { city: "Provo–Orem", state: "UT", zones: 6 },
  { city: "St. George", state: "UT", zones: 3 },
  { city: "Park City", state: "UT", zones: 2 },
];
